function [h_line, h_patch] = lpp_plot_shading(xaxis, mean, error, varargin)
...
h_line = plot(xaxis, mean, LineSpec, 'linewidth', linew, 'color', color, 'MarkerSize', 10, 'MarkerFaceColor', color);
